...
Axiom 0.6.1-alpha.1. Runtime guarantees, stated formally. This file defines behavior; it
...
**Not guaranteed in 0.6.1**, and stated so rather than implied: read authorization per caller
