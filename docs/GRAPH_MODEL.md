...
Axiom 0.5.1-alpha.1. The `ApplicationGraph` is the authoritative representation of an
...
```ts
const graph = new ApplicationGraph(id, name, version?);   // version defaults to '0.5.1'
